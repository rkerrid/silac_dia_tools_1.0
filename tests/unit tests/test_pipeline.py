...
class TestPipeline(unittest.TestCase):
    ...
    def test_pipeline_initialization(self):
        ...
        test_no_spike = pipeline('C:/phd projects/silac_dia_tools_1.0/tests/unit tests/unit test data/spike/',  method='dynamic_silac_dia', pulse_channel='M', metadata_file='meta.csv')
        test_spike = pipeline('C:/phd projects/silac_dia_tools_1.0/tests/unit tests/unit test data/spike/',  method='dynamic_dia_sis', pulse_channel='M', metadata_file='meta.csv')
